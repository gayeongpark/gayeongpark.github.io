...
5. **BGP (Border Gateway Protocol)**
   ...
   - Characteristics: Routes based on **autonomous system number** rather than individual routers. Backbone of the internet. By using ASNs, network operators can maintain control over the routing within their network and communicate routing information effectively with other ASes. Slow convergence.
