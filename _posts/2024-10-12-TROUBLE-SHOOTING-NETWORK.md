...
- Latency : Time it takes for a signal to reach the intended client. For providing stable service, I need to keep latency under 50 to 100 milliseconds

- Jitter : Measurement of the variation in delay over time. When latency increases by up to 30-50 milliseconds, it starts to have jitter
